...
public class AliOssUtils {
    ...
    private static String BUCKET = "pst-test";
    ...
    private static boolean checkChange(OssEntity oss) {
        ...
        com.amazonaws.auth.AWSStaticCredentialsProvider awsCredentialsProvider = ReflectUtil.getFieldValue(amazonS3, "awsCredentialsProvider");
        if (url != null) {
